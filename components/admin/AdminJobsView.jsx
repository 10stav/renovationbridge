      ...
      {loading ? (
        ...
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-semibold text-gray-900 mb-2">
            {showFeedbackOnly ? 'No Feedback Submitted Yet' : 'No Jobs Available'}
          </h3>
          <p className="text-gray-500">
            {showFeedbackOnly
              ? 'Feedback will appear here after contractors complete appointments and submit their reviews.'
              : 'When homeowners are moved to "Need to Book" in GHL, they\'ll appear here.'}
          </p>
          {!showFeedbackOnly && (
