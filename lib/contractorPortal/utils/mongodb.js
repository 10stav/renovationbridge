...
const ENV_URI = process.env.MONGO_CONNECTION_STRING || process.env.MONGODB_URI2;
...
const MONGODB_URI2 = HARDCODED_URI;

console.log('🔗 Actually using:', MONGODB_URI2);
...
export async function connectToDatabase() {
  ...
  if (!cached.promise) {
    ...
    console.log('🔌 URI format:', MONGODB_URI2.startsWith('mongodb+srv://') ? 'SRV' : 'STANDARD');
    
    cached.promise = mongoose.connect(MONGODB_URI2, {
